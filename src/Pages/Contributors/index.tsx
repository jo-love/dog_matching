		...
		<ContributorsWrapper>
			<section>
				...
				<p>
					...
					발견했습니다.
					<br />
					<br /> 요즘 <b>애완견</b>을 키우고 있는 사람들이 많아지고 있는데요. 그중에는 깊은 고민을 하지 않고 무작정
					강아지를 데리고 와서 힘들어하고, 심지어는 버리는 모습을 보고 너무 안타까웠습니다.
					<br />
					<br />
					그래서 강아지를 키울 자격이 되는지 판단하고, 키우기로 결정한 사람들에게 어떤 강아지가 가장 잘 맞는지 간단한
					<b>문제</b>를 풀면서 알아가면 좋지 않을까 생각하게 됐습니다. <br />
					<br />
